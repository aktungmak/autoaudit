...
description = "EN8000 series encoder"

lg = logging.getLogger('autoaudit')

class Device(object):
    def __init__(self, ipa):
        lg.debug('creating new en8000 at %s', ipa)
        self.info = {
            'productname'  : None,
            'servicename'  : None,
            'ipaddress'    : ipa,
        ...
        self.oids = {
            ...
            'servicename'  : '1.3.6.1.4.1.1855.2.2.1.11.1.5.1',
        ...
        self.xpaths = {
            'servicename'  : './/Choice[@N="Decode Service"]'
        }
